...
@section('content')
	...
	<div id="page">
		...
		<div id="fh5co-counter" class="fh5co-counters fh5co-bg-section" style="padding-top: 0px;">
			...
			<div class="cat-lst-bg gallerysection">
				<div class="container ">
					<div class="row">
						<div class="col-md-12">
							...
							<div>
								<div class="right-side-home loader-right-side">
									<div class="product-list">
										<div class="row galleryrow" id="rows">
														...
														<div class="p-box-lent">
															...
															<div class="books-inof">
																...
																<a href="{{ route('profile',$value->user_id) }}">
																	<p class="person-name" ><i  style=' color: #753339;' class="fa fa-user"></i>{{ $value->owner_name.' '.$value->total_products }} <i class="icon-drop-up-arrow size-13 green-color"></i> {{ $value->up_points }} <i class="icon-drop-down-arrow size-13 brown-color"></i> {{ $value->down_points }} </p>
																</a>
			...
			function loadCategories () {
				$.ajax({
						...
						success:function(data){
								...
								sub_category_id.append('<option value=""> All Categories</option>');
